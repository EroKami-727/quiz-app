...
const YourQuizzes = () => {
  ...
  // View results (placeholder for now)
  const handleViewResults = (quiz) => {
    // This would navigate to a results page filtered by quiz ID
    // For now, just show a message
    setSuccessMessage(`Viewing results for "${quiz.title}" - Feature coming soon!`);
    setTimeout(() => setSuccessMessage(''), 3000);
  };
  ...
  const handleToggleActive = async (quiz) => {
    ...
    try {
      ...
      setSuccessMessage(`Quiz ${!quiz.active ? 'activated' : 'deactivated'} successfully!`);
      setTimeout(() => setSuccessMessage(''), 3000);
    } catch (error) {
              ...
              <div key={quiz.id} className="quiz-card">
                ...
                <div className="quiz-card-actions">
                  ...
                  <button 
                    ...
                    className={`action-btn ${quiz.active ? 'warning' : 'success'}`}
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <p className="quiz-description-modal">
                ...
                <div className="quiz-info-grid">
                  ...
                  <div className="info-item">
                    ...
                    <span className="value">{selectedQuiz.timeLimit || 60} seconds</span>
                  </div>
                  <div className="info-item">
                    <span className="label">Status:</span>
                    <span className={`value status ${selectedQuiz.active ? 'active' : 'inactive'}`}>
                      {selectedQuiz.active ? 'Active' : 'Inactive'}
                    </span>
                  </div>
                  <div className="info-item">
                      ...
                      <div className="question-content">
                        ...
                        <div className="options-preview">
                          {question.options?.map((option, optionIndex) => (
                            <div 
                              key={optionIndex} 
                              className={`option-preview ${optionIndex === question.correctOption ? 'correct' : ''}`}
                            >
