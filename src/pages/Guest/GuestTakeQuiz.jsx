    ...
    const handleSubmitQuiz = async () => {
        ...
        try {
            ...
            const resultDoc = {
                ...
                username, // Save guest's name
                quizTitle: quiz.title,
                status: requiresManualGrading ? 'pending' : 'completed',
                score: totalScore,
                bonus: speedBonus,
                ...
                {finalResults ? (
                    <div className="quiz-completed-container">
                        ...
                        <div className="completion-actions">
                            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate('/login')} className="return-button">Back to Home</motion.button>
                        </div>
                    </div>
                ) : (
                    <div className="quiz-completed-container">
